...
This extension connects Claude Desktop to Aclymate's carbon accounting API. When you use Aclymate tools through Claude, your queries (industry type, employee count, activity descriptions) are sent to Aclymate's servers to generate responses.
